...
if(QT_ENABLE)
    ...
    if(NOT list_length EQUAL 0)
        ...
        message("logError: QT_MODULES is empty. Please specify the required modules or set the variable \"QT_ENABLE\" to OFF")
    endif()
endif()
# end QT settings
...
if(${PROFILING_NAME})
    if(NOT TARGET ${PARENT_LIBRARY_STATIC_PROFILE})
        message("logError: Target: PARENT_LIBRARY_STATIC_PROFILE does not exist")
        message("logError: Target: Make shure you have added the dependency: easy_profiler.cmake and set(EASY_PROFILER_IS_AVAILABLE ON)")
    endif()
