...
/// USER_SECTION_END
	...
	public:
		...
		static constexpr int versionMajor				= SQLiteWrapper_VERSION_MAJOR;
		static constexpr int versionMinor				= SQLiteWrapper_VERSION_MINOR;
		static constexpr int versionPatch				= SQLiteWrapper_VERSION_PATCH;
		...
		static constexpr const char* name				= SQLiteWrapper_LIBRARY_NAME;
		static constexpr const char* author				= "Alex Krieg";
		static constexpr const char* email				= "";
		static constexpr const char* website			= "https://www.sqlite.org/index.html";
		static constexpr const char* license			= "PD";
