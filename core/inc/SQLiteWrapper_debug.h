...
// FileChangeWatcher
#define SQLW_FILE_WATCHER_PROFILING_COLORBASE Green
#define SQLW_FILE_WATCHER_PROFILING_THREAD(name) SQLW_PROFILING_THREAD(name)
#define SQLW_FILE_WATCHER_PROFILING_BLOCK_C(text, color) SQLW_PROFILING_BLOCK_C(text, color)
#define SQLW_FILE_WATCHER_PROFILING_NONSCOPED_BLOCK_C(text, color) SQLW_PROFILING_NONSCOPED_BLOCK_C(text, color)
#define SQLW_FILE_WATCHER_PROFILING_END_BLOCK SQLW_PROFILING_END_BLOCK;
#define SQLW_FILE_WATCHER_PROFILING_FUNCTION_C(color) SQLW_PROFILING_FUNCTION_C(color)
#define SQLW_FILE_WATCHER_PROFILING_BLOCK(text, colorStage) SQLW_PROFILING_BLOCK(text, CONCAT_SYMBOLS(SQLW_FILE_WATCHER_PROFILING_COLORBASE, colorStage))
#define SQLW_FILE_WATCHER_PROFILING_NONSCOPED_BLOCK(text, colorStage) SQLW_PROFILING_NONSCOPED_BLOCK(text, CONCAT_SYMBOLS(SQLW_FILE_WATCHER_PROFILING_COLORBASE, colorStage))
#define SQLW_FILE_WATCHER_PROFILING_FUNCTION(colorStage) SQLW_PROFILING_FUNCTION(CONCAT_SYMBOLS(SQLW_FILE_WATCHER_PROFILING_COLORBASE, colorStage))
#define SQLW_FILE_WATCHER_PROFILING_VALUE(name, value) SQLW_PROFILING_VALUE(name, value)
#define SQLW_FILE_WATCHER_PROFILING_TEXT(name, value) SQLW_PROFILING_TEXT(name, value)
